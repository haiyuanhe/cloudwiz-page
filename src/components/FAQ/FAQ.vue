          ...
          lists: [
            {
              ...
              a: '通过安装我们定制的采集收集器(探针), 来采集需要的数据, 如果是内网用户,能够将数据发送到外网即可使用。我们同时支持多种采集手段，包括无探针采集方式。具体联系 service@cloudwiz.cn 获取更多不同的方案细节。'
            },
            {
              state: false,
              q: '如何安装/使用?如何获得服务?',
              a: '请先联系service@cloudwiz.cn给出具体的账号才能开始使用, 我们会配合用户给出一份满意和定制化的方案。'
            },
            {
              state: false,
              q: '你们的数据采集会影响service性能吗?',
            ...
            },
            {
              state: false,
              q: '你们的产品是免费的还是收费的?',
              a: '可以联系service@cloudwiz.cn或致电010-62958816询问详情。'
            },
            {
              state: false,
              q: '如何保证数据的安全性?',
              a: `
                <p>加密传输：数据传输都是在https的SSL端口进行传输，防止嗅探。同时，在传输过程中会采取加密和混淆的方式，生成一系列无法被识别的代码和字符串，从而达到安全传输的目的。</p>
