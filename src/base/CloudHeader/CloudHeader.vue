  ...
  <div class="header-wrapper">
    <div class="header-container">
      ...
      <div class="mobail" v-show="this.screenWidth <= 970">
        <a-dropdown :trigger="['click']" class="mobail-menu" style="min-width: 100%">
          <div class="ant-dropdown-link">
            <a-icon :type="type" @click="open"/>
          </div>
          <a-menu slot="overlay" theme="dark" class="menu-lists">
            <a-menu-item>
              <router-link class="menu-item home" to="/home">
                <span class="tab-link">首页</span>
              </router-link>
            ...
            <a-collapse accordion>
              <a-collapse-panel header="产品中心" style="background: #001529;color: #a8adaf;border:none;">
                <a-menu-item>
                  <router-link to="/cloudwiz">
                    <span>Cloudwiz</span>
                  </router-link>
            ...
            <a-collapse accordion>
              <a-collapse-panel header="关于我们" style="background: #001529;color: #a8adaf;border:none;">
                <a-menu-item>
                  <router-link to="/about">
                    <span>关于公司</span>
                  </router-link>
            ...
            <a-menu-item diabled>离线分析平台</a-menu-item>
          </a-menu>
        </a-dropdown>
      </div>
    </div>
...
export default {
  ...
  methods: {
    open () {
      this.type = this.type === 'menu-unfold' ? 'menu-fold' : 'menu-unfold'
    }
  }
}
</script>
